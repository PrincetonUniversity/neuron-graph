      ...
      .then(() => {
        ...
        this.view.help.setWelcomeContent(
          ...
          [
            ...
            '<b>NemaNode</b>.',
            '<p>',
            'Functional connectivity measurements show the causal direction of information',
            ...
            '<p>',
            'Randi, Sharma, Dvali and Leifer, <i>Direct measurements of functional </i>',
            '<i>connectivity in C. elegans reveals contributions from extrasynaptic</i>',
            '<i>signaling.</i>',
            '<p>',
